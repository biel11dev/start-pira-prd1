...
const Ponto = () => {
  ...
  const fetchEmployees = async (date) => {
    setLoading(true);
    try {
      const employeesResponse = await axios.get("https://api-start-pira-prd1.vercel.app/api/employees");
      ...
      const dailyPointsResponse = await axios.get("https://api-start-pira-prd1.vercel.app/api/daily-points");
...
const addWatermark = () => {
  ...
  const fetchWeeklyData = async (dateRef) => {
    ...
    try {
      const employeesResponse = await axios.get("https://api-start-pira-prd1.vercel.app/api/employees");
      const dailyPointsResponse = await axios.get(`https://api-start-pira-prd1.vercel.app/api/daily-points?startDate=${startDateStr}&endDate=${endDateStr}`);
  ...
  const fetchMonthlyData = async (dateRef) => {
    ...
    try {
      const employeesResponse = await axios.get("https://api-start-pira-prd1.vercel.app/api/employees");
      const dailyPointsResponse = await axios.get(`https://api-start-pira-prd1.vercel.app/api/daily-points?month=${currentMonth}`);
...
const handleSaveEdit = () => {
  ...
  const handleRegisterTime = async (id) => {
    try {
      ...
      const dailyPointsResponse = await axios.get(`https://api-start-pira-prd1.vercel.app/api/daily-points/${id}?date=${currentDate}`);
      ...
      if (dailyPoint && dailyPoint.id) {
        await axios.put(`https://api-start-pira-prd1.vercel.app/api/daily-points/${dailyPoint.id}`, dataToUpdate);
      } else {
        await axios.post(`https://api-start-pira-prd1.vercel.app/api/daily-points`, dataToUpdate);
      }
  ...
  const handleAddEmployee = async () => {
    ...
    try {
      ...
      const response = await axios.post("https://api-start-pira-prd1.vercel.app/api/employees", newEmployee);
  ...
  const handleRemoveEmployee = async (id) => {
    setMessage({
      ...
      onConfirm: async () => {
        try {
          await axios.delete(`https://api-start-pira-prd1.vercel.app/api/daily-points?employeeId=${id}`);
          await axios.delete(`https://api-start-pira-prd1.vercel.app/api/employees/${id}`);
  ...
  const handleDeleteDailyPoint = async (employeeId, date) => {
    try {
      const currentDate = new Date(date);
      const response = await axios.get(`https://api-start-pira-prd1.vercel.app/api/daily-points/${employeeId}?employeeId=${employeeId}&date=${currentDate.toISOString().split("T")[0]}`);
      const dailyPoints = response.data;
      const dailyPoint = Array.isArray(dailyPoints) ? dailyPoints[0] : dailyPoints;

      if (dailyPoint && dailyPoint.id) {
        await axios.delete(`https://api-start-pira-prd1.vercel.app/api/daily-points/${dailyPoint.id}`);
  ...
  const handleUpdateEmployee = async (id, updatedData) => {
    try {
      await axios.put(`https://api-start-pira-prd1.vercel.app/api/employees/${id}`, updatedData);
  ...
  const getDailyPointForEmployee = (employeeId, date) => {
    ...
    return axios.get(`https://api-start-pira-prd1.vercel.app/api/daily-points/${employeeId}?date=${encodeURIComponent(dateWithTime)}`).then((res) => {
  ...
  const handleConfirmFalta = async (tipo) => {
    ...
    try {
      ...
      if (faltaPoint && faltaPoint.id && tipo === "falta") {
        await axios.put(`https://api-start-pira-prd1.vercel.app/api/daily-points/falta/${faltaEmployee.id}`, dataToUpdate);
      } else {
        await axios.put(`https://api-start-pira-prd1.vercel.app/api/daily-points/${faltaEmployee.id}`, dataToUpdate);
      }
  ...
  const handleConfirmFaltaManual = async (tipo) => {
    ...
    try {
      ...
      if (faltaPointManual && tipo === "falta") {
        await axios.put(`https://api-start-pira-prd1.vercel.app/api/daily-points/falta-manual/${faltaEmployeeManual.id}`, dataToUpdate);
      } else {
        await axios.put(`https://api-start-pira-prd1.vercel.app/api/daily-points/${faltaEmployeeManual.id}`, dataToUpdate);
      }
