...
const ProductList = () => {
  ...
  const fetchCategories = () => {
    axios
      .get("https://api-start-pira-prd1.vercel.app/api/categories")
  ...
  const handleAddProduct = () => {
    if (
      ...
      setIsLoading(true);
      axios
        .post("https://api-start-pira-prd1.vercel.app/api/products", {
          name: newProduct,
          quantity,
          unit,
          value,
  ...
  const handleSaveProduct = () => {
    if (editingProduct) {
      ...
      axios
        .put(`https://api-start-pira-prd1.vercel.app/api/estoque_prod/${editingProduct}`, { 
          name, 
          quantity, 
          unit, 
          value, 
  ...
  const confirmDeleteProduct = () => {
    ...
    axios
      .delete(`https://api-start-pira-prd1.vercel.app/api/estoque_prod/${id}`)
      .then(() => {
